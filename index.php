...
$work_experience = [
    [
        ...
        'accepted for work' => 'Январь 2015',
        'dismissed' => 'Работает по настоящее время',
        'job description' => 'Отличная работа'
    ],
    [
        'work' => 'Web Developer / something.com',
        'accepted for work' => 'Март 2012',
        'dismissed' => 'Декабрь 2014',
        'job description' => 'Хорошая работа'
    ],
    [
        'work' => 'Graphic Designer / designsomething.com',
        'accepted for work' => 'Июнь 2010',
        'dismissed' => 'Март 2012',
        'job description' => 'Нормальная работа'
    ],
];
?>
          ...
          <h2 class="w3-text-grey w3-padding-16"><i
              class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Опыт работы</h2>
                <?php for ($i = 0; $i < count($work_experience); $i++):?>
                     <div class="w3-container">
                        <h5 class="w3-opacity"><b><?= $work_experience[$i]["work"]; ?> </b></h5>
                        <h6 class="w3-text-teal">
                            <i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $work_experience[$i]["accepted for work"]; ?> -
                                <?php if ($i == 0):?>
                                    <span class="w3-tag w3-teal w3-round"><?= $work_experience[$i]["dismissed"]; ?></span>
                                <?php else :?>
                                    <?= $work_experience[$i]["dismissed"]; ?>
                                <?php endif;?>
                        </h6>
                        <p><?= $work_experience[$i]["job description"]; ?></p>
                        <hr>
                      </div>
                <?php endfor;?>
            </div>
